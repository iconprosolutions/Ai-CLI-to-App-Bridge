# AI CLI Bridge — Design System

> **Selected visual direction** for the AI CLI Bridge web surfaces (the provider dashboard
> and any future pages). Derived from the **Together AI** brand system — *"the gradient is the brand."*
> This document is the source of truth for palette, typography, surface rhythm, and component chrome.
> Precedence: the user's explicit instructions → this design system → implementer's own choices.
